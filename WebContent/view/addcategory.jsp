...
<div class="wrap js-check-wrap">
    <ul class="nav nav-tabs">
        <li><a href="category.cat">分类管理</a></li>
        <li class="active"><a href="addCategory.cat">添加分类</a></li>
    </ul>
        ...
        <div class="col-md-6">
            <form class="js-ajax-form" action="{:url('AdminCategory/addPost')}" method="post">
                ...
                <div class="form-group">
                    ...
                    <a class="btn btn-default" href="{:url('AdminCategory/index')}">返回</a>
                </div>
            </form>
        </div>
    </div>
</div>
<script type="text/javascript" src="<%=request.getContextPath()%>/public/admin/js/admin.js"></script>
</body>
</html>